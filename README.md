...
[![Version](https://img.shields.io/badge/version-1.47.0-blue.svg)](https://github.com/whoishzp/magicer/releases)
...
2. **定时提醒**：新增规则，配置触发方式（循环/定点）、蒙层主题和停留时长
3. **当前状态**：实时查看各规则倒计时进度
